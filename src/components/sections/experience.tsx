...
const EXPERIENCE = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Managed GitHub workflows, integrated frontend and backend systems, and led the deployment migration to Render, Supabase, and Vercel.",
    ],
    tags: ["React", "TypeScript", "Django", "PostgreSQL", "Render", "AI"],
  },
  {
