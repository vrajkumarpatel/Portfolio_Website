...
const AnimatedBackground = () => {
  ...
  const DEFAULT_HEADING = "press keys";
  const DEFAULT_DESC = "";
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      if (activeSection === "skills") {
        splineApp.setVariable("heading", DEFAULT_HEADING);
  ...
  const handleSplineInteractions = () => {
    ...
    splineApp.addEventListener("keyDown", (e) => {
      ...
      if (skill) {
        ...
        // Fallback: show raw target name to confirm interaction
        splineApp.setVariable("heading", e.target.name || DEFAULT_HEADING);
        splineApp.setVariable("desc", DEFAULT_DESC);
      }
      // Press feedback
      if (target?.position) {
  ...
  useEffect(() => {
    if (typeof document !== "undefined") {
      ...
      root.style.setProperty("--bg-z", "-10");
      root.style.setProperty(
        "--bg-pointer",
        activeSection === "skills" ? "auto" : "none"
      );
    }
  }, [activeSection]);
  return (
      ...
      <Suspense fallback={<div>Loading...</div>}>
        ...
        >
          ...
          onLoad={(app: Application) => {
            setSplineApp(app);
            bypassLoading();
            app.setVariable("heading", DEFAULT_HEADING);
            app.setVariable("desc", DEFAULT_DESC);
          }}
