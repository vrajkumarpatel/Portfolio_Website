...
const CONTACT_LINKS = [
  {
    name: "LinkedIn",
    href: "https://linkedin.com/in/vrajkumar-patel-87200017b",
    content: "/vrajkumar-patel-87200017b",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/vrajkumarpatel",
    content: "/vrajkumarpatel",
    icon: <FaGithub height={"50px"} />,
  },
  {
    name: "Instagram",
    href: "https://instagram.com/vraj___patel__07",
    content: "@vraj___patel__07",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Vrajkumar Patel</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              I&apos;m a Computer Science student with a concentration in Artificial Intelligence, focusing on machine learning algorithms, deep learning, and intelligent systems. I combine theoretical knowledge with practical implementation to solve complex problems using cutting-edge AI technologies.
            </p>
            <p className="mb-10">
              I love building intelligent systems and modern web apps, exploring new technologies, and turning research ideas into practical projects.
            </p>
