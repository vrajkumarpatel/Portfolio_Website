      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ref={modalRef}
            className={cn(
              "min-h-[50%] max-h-[90%] md:max-w-4xl bg-white dark:bg-neutral-950 border border-transparent dark:border-neutral-800 md:rounded-2xl relative z-50 flex flex-col overflow-hidden",
              className
            )}
            initial={{
              opacity: 0,
...
export const ModalContent = ({
  ...
  return (
    <div 
      className={cn("flex-1 w-full overflow-y-auto rounded-md", className)}
      data-lenis-prevent
